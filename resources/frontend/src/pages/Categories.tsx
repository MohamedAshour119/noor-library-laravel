                ...
                <div className={`flex flex-col items-center bg-main_bg pt-5 max-sm:px-2 h-full`}>
                    <div className={`container w-full flex flex-col gap-y-3`}>
                        ...
                        <div className="relative">
                            <input
                                type="text"
                                className="w-full px-4 pe-28 py-3 border border-gray-300 rounded-md focus:outline-none focus:border-main_color"
                            ...
                            <button
                                ...
                                className="absolute right-14 top-1/2 transform -translate-y-1/2 bg-transparent py-1 px-2 rounded border hover:bg-main_bg hover:border-black/20">
                        ...
                        <div className={`flex flex-col gap-y-4 pb-4`}>
                            ...
                            {search_value.length > 0 && categories.length === 0 &&
                                <>
                                    ...
                                    <h2 className="text-center text-black text-base font-semibold leading-relaxed pb-1">Category not found!</h2>
                                </>
