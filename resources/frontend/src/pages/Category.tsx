    ...
    useEffect(() => {
        ...
        const observer = new IntersectionObserver(entries => {
            if (entries[0].isIntersecting && !is_fetching && books_next_page_url) {
                getCategoryBooks(books_next_page_url, false);
            }
        }, {
                        ...
                        <div className={`flex flex-col gap-y-4 pb-4`}>
                            {books.length === 0 &&
                                <>
                                    ...
                                    <h2 className="text-center text-text_color/70 text-xl font-semibold leading-relaxed pb-1">This category has no books yet!</h2>
                                </>
                            }
                        </div>
                    </div>
