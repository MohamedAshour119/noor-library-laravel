    ...
    return (
        <>
            ...
            <a
                ref={ref}
                href={`/books/${slug}`}
                className={`${styles ? styles : ''} z-40 relative group relative flex flex-col justify-self-center gap-y-2 md:w-full w-fit items-center border bg-white p-5 rounded-lg hover:border-main_color transition`}
            >
